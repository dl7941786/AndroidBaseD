...
import com.qianfeng.day07homework.model.MainActivityModel;
import com.qianfeng.day07homework.model.MainActivityModel2;
...
//    }
    ...
    public MainActivityPresenter setMvpModel(int i) {
        switch (i) {
            case 0:
                mvpModel = new MainActivityModel();
                break;
            case 1:
                mvpModel = new MainActivityModel2();
                break;
        }
        //
        return this;
    ...
    public void load(String path) {
        mvpModel.getData(new MvpModel.OnLoadCompleteListener() {
            ...
            public void onLoadComplete(byte[] bs, String path) {
                ...
                ReCaiBean reCaiBean = new Gson().fromJson(json, ReCaiBean.class);
                getView().showView(reCaiBean.getObj().getData());
            }
        }, path);
    }
