...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) convertView.findViewById(R.id.name)).setText(bluetoothDevice.getName());
        ((TextView) convertView.findViewById(R.id.address)).setText(bluetoothDevice.getAddress());
        return convertView;
    }
}
