package com.qianfeng.listviewdemo2.callback;
 ...
 */
public class MyBitMapCallBack implements MyAsyncTask.OnLoadCompleteListener {
    ...
    @Override
    public void onLoadComplete(byte[] bytes,String requestPath) {
        if (bytes != null) {
